...
export default function TcgYugioh() {
  const { cards, isLoading, totalValue, totalCost, totalGain, totalGainPercent, createCard, updateCard, deleteCard } = useTcgCards('yugioh');
  ...
  // YGO cards have no set_code, so no set filter needed
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <h1 className="text-3xl font-display font-bold">Yu-Gi-Oh!</h1>
            <p className="text-muted-foreground">Collezione carte Yu-Gi-Oh!</p>
          </div>
          <Dialog open={open} onOpenChange={(o) => { if (!o) resetDialog(); else setOpen(true); }}>
            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
              <DialogHeader><DialogTitle>Aggiungi carta Yu-Gi-Oh!</DialogTitle></DialogHeader>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <Input
                      ...
                      placeholder="es. Dark Magician, Blue-Eyes..."
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <Input placeholder="Cerca per nome..." value={filterText} onChange={(e) => setFilterText(e.target.value)} className="max-w-sm" />
          {uniqueSets.length > 0 && (
              ...
              return (
                <div key={card.id} className="grid grid-cols-[auto_1fr_auto_auto_auto_auto_auto_auto] gap-4 items-center px-4 py-3">
                  ...
                  <div>
                    ...
                    {card.set_code && <p className="text-xs text-muted-foreground">{card.set_code}</p>}
                  </div>
