...
function dedupeBooks(items: GoogleBook[]): GoogleBook[] {
...
async function searchFumetti(q: string): Promise<GoogleBook[]> {
  // Try comics+graphic novels in Italian first, fall back to unrestricted
