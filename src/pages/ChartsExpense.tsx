...
export default function ChartsExpense() {
  ...
  // Raggruppa le transazioni per categoria di spesa
  ...
  const lineChartData = useMemo(() => {
    ...
    const transactionDates = expenseTransactions.map(t => parseISO(t.date));
    ...
    return data;
  }, [filteredTransactions, expenseCategories, filterMode, selectedYear, selectedMonth, sinceDate, fromDate, toDate]);
    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-display font-bold">Analisi Uscite</h1>
            <p className="text-muted-foreground">Distribuzione delle spese per categoria</p>
          </div>
        </div>
