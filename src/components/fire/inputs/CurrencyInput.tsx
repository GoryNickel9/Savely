...
export default function CurrencyInput({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // If showInvalidState is enabled, don't clamp min value - just let it through
    if (showInvalidState) {
  ...
  const formattedValue = new Intl.NumberFormat('it-IT').format(Math.round(displayValue))
